...
import { IWhatsAppEngine, EngineStatus, EngineEventCallbacks, MessageResult, MediaInput, IncomingMessage, Contact, Group, GroupInfo, LocationInput, ContactCard, MessageReaction, Label, Channel, ChannelMessage, Status, TextStatusOptions, StatusResult, Catalog, Product, ProductQueryOptions, PaginatedProducts, ChatSummary, ChatState, DeliveryStatus } from '../interfaces/whatsapp-engine.interface';
...
export declare function resolveWebVersionPin(): {
    webVersion: string;
    webVersionCache: {
        type: 'remote';
        remotePath: string;
