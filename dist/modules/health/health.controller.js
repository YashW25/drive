...
let HealthController = class HealthController {
    ...
    engineFactory;
    configService;
    constructor(mainDataSource, dataDataSource, shutdownService, engineFactory, configService) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Lightweight keep-alive heartbeat' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Service is alive' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Object)
], HealthController.prototype, "heartbeat", null);
__decorate([
    (0, common_1.Get)('debug/environment'),
    (0, swagger_1.ApiOperation)({ summary: 'Debug environment variables (development only)' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], HealthController.prototype, "getEnvironmentDebug", null);
__decorate([
    (0, common_1.Get)('live'),
