...
const wa_id_value_1 = require("../../../engine/identity/wa-id.value");
const canonicalActor = (jid, resolve) => wa_id_value_1.WaId.fromEngineJid(jid, resolve).toNeutral().toLowerCase();
const canonicalInput = (value) => wa_id_value_1.WaId.fromUserInput(value).toNeutral().toLowerCase();
