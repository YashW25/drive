...
export declare class MessageService {
    ...
    constructor(messageRepository: Repository<Message>, sessionService: SessionService, hookManager: HookManager, templateService: TemplateService, lidMappingStore: LidMappingStoreService);
