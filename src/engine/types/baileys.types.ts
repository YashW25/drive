...
export interface BaileysAdapterConfig {
  ...
  /** Pluggable auth storage provider for Render and other ephemeral environments. */
  authStorageProvider?: import('../storage/auth-storage.interface').IAuthStorageProvider;
}
